defmodule TimeTrackerBackend.OrganizationControllerTest do
  ...
  test "shows chosen resource", %{conn: conn} do
    ...
    "name" => organization.name, "is_active" => organization.is_active, "logo" => organization.logo, "team_size" => organization.team_size,
    "description" => organization.description, "created_by" => organization.created_by, "deleted" => organization.deleted,
    "users" => []}
  end
